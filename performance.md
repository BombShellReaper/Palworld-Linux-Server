...
* **`LowerBound=60.000000`**: Raising the frame rate smoothing boundary floor to `60` ensures that your Proxmox VM resources prioritize keeping the server running fluidly without allowing sudden drop-offs below standard refresh targets.
